...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Solution.end'
        db.delete_column('problem_solution', 'end')

        # Deleting field 'Solution.label'
        db.delete_column('problem_solution', 'label')

        # Deleting field 'Solution.start'
        db.delete_column('problem_solution', 'start')


    def backwards(self, orm):
        
        # Adding field 'Solution.end'
        db.add_column('problem_solution', 'end', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Solution.label'
        db.add_column('problem_solution', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Solution.start'
        db.add_column('problem_solution', 'start', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
