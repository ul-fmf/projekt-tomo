...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Part.secret'
        db.delete_column('problem_part', 'secret')

        # Adding field 'Part.answers'
        db.add_column('problem_part', 'answers', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Part.secret'
        db.add_column('problem_part', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Deleting field 'Part.answers'
        db.delete_column('problem_part', 'answers')
