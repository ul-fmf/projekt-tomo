...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('problem_solution', 'solution', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Solution.solution'
        db.delete_column('problem_solution', 'solution')
