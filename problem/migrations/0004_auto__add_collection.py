...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('problem_collection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=70)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='10', max_length=2)),
        ))
        db.send_create_signal('problem', ['Collection'])

        # Adding M2M table for field problems on 'Collection'
        db.create_table('problem_collection_problems', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['problem.collection'], null=False)),
            ('problem', models.ForeignKey(orm['problem.problem'], null=False))
        ))
        db.create_unique('problem_collection_problems', ['collection_id', 'problem_id'])


    def backwards(self, orm):
        
        # Deleting model 'Collection'
        db.delete_table('problem_collection')

        # Removing M2M table for field problems on 'Collection'
        db.delete_table('problem_collection_problems')
