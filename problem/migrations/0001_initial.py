...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('problem_problem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=70)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('trial', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('problem', ['Problem'])

        # Adding model 'Part'
        db.create_table('problem_part', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parts', to=orm['problem.Problem'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('trial', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('problem', ['Part'])

        # Adding model 'Submission'
        db.create_table('problem_submission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('download_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('upload_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
        ))
        db.send_create_signal('problem', ['Submission'])

        # Adding model 'Solution'
        db.create_table('problem_solution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='solutions', to=orm['auth.User'])),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='solutions', to=orm['problem.Part'])),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='solutions', to=orm['problem.Submission'])),
            ('start', self.gf('django.db.models.fields.IntegerField')()),
            ('end', self.gf('django.db.models.fields.IntegerField')()),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('problem', ['Solution'])


    def backwards(self, orm):
        
        # Deleting model 'Problem'
        db.delete_table('problem_problem')

        # Deleting model 'Part'
        db.delete_table('problem_part')

        # Deleting model 'Submission'
        db.delete_table('problem_submission')

        # Deleting model 'Solution'
        db.delete_table('problem_solution')
