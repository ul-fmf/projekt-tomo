...
DATABASES = {
    'default': {
        ...
        'NAME': 'tomo',                      # Or path to database file if using sqlite3.
        'USER': 'tomo',                      # Not used with sqlite3.
...
MEDIA_ROOT = '/home/matija/django/tomo/static/'
...
TEMPLATE_DIRS = (
    ...
    '/home/matija/django/tomo/templates',
)
