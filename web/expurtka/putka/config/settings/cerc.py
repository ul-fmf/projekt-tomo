...
ALERT_TYPES = IntegerChoices('ALERT_TYPES', [(a.name, (a.value, a.label)) for a in ALERT_TYPES] + [
...
assert set(ALERT_TYPES) == set(ALERT_SUBCLASS_MAP), f"{set(ALERT_TYPES)} vs. {set(ALERT_SUBCLASS_MAP)}"
...
TEMPLATES[0]['OPTIONS']['context_processors'].append('ui.printing.context_processors.settings')
