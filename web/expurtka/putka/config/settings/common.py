...
LANG_COLLATOR = {
    lang: icu.Collator.createInstance(icu.Locale(lang)) for lang, _ in LANGUAGES
}
...
if PROMETHEUS_ENABLED:
    MIDDLEWARE = (
        ("ui.core.controlpanel.prometheus.TopMiddleware",)
        + MIDDLEWARE
        + ("ui.core.controlpanel.prometheus.BottomMiddleware",)
    )
    ...
    "loggers": {
        ...
        "django.request": {
            "handlers": [
                ...
                "file",
                "mail_admins",
            ],  # standard access logs are already handled by frontend proxies etc.
            "level": "ERROR",
            "propagate": False,
        },
...
LOCALMETRICS_WINDOW_MINUTES = (
    2 * 24 * 60
)  # Two days of histogram history for local metrics.
...
MARKDOWNX_MARKDOWN_EXTENSIONS = [
    ...
    "ui.core.wiki.markdown_support:EscapeHtml",
    "ui.core.wiki.markdown_support:MathJaxExtension",
]
