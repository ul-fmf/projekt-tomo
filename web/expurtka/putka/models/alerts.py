...
from expurtka.putka.alert_types import (
    AlertBase,
    AlertPermissionCheckResult,
    AlertRenderInfo,
)
...
class Alert(models.Model):
    ...
    type = models.PositiveSmallIntegerField(
        verbose_name="Alert type", choices=settings.ALERT_TYPES.choices
    )
    ...
    def for_thread_activity(*, user: "UserType", thread: "Thread") -> "Alert":
        return Alert(
            user=user,
            type=settings.ALERT_TYPES.thread_activity,
            related_object=thread.concrete(),
        )
    ...
    def for_manual_grading(*, user: "UserType", upload: "Upload") -> "Alert":
        return Alert(
            user=user,
            type=settings.ALERT_TYPES.manual_grading,
            related_object=upload,
            perms_checked=True,
        )
    ...
    def for_suspicious_upload(*, user: "UserType", upload: "Upload") -> "Alert":
        return Alert(
            user=user,
            type=settings.ALERT_TYPES.pragma,
            related_object=upload,
            perms_checked=True,
        )
    ...
    def for_internal_error(*, user: "UserType", upload: "Upload") -> "Alert":
        return Alert(
            user=user,
            type=settings.ALERT_TYPES.internal_error,
            related_object=upload,
            perms_checked=True,
        )
