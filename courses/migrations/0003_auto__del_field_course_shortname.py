...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.shortname'
        db.delete_column(u'courses_course', 'shortname')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Course.shortname'
        raise RuntimeError("Cannot reverse this migration. 'Course.shortname' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Course.shortname'
        db.add_column(u'courses_course', 'shortname',
