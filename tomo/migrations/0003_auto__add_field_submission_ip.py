...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tomo_submission', 'ip', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.ip'
        db.delete_column('tomo_submission', 'ip')
