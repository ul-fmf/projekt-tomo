...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.timestamp'
        db.add_column('tomo_course', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 3, 1, 13, 54, 51, 427754), blank=True), keep_default=False)

        # Adding field 'Part.timestamp'
        db.add_column('tomo_part', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 3, 1, 13, 55, 2, 6064), blank=True), keep_default=False)

        # Adding field 'ProblemSet.timestamp'
        db.add_column('tomo_problemset', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 3, 1, 13, 55, 4, 814201), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.timestamp'
        db.delete_column('tomo_course', 'timestamp')

        # Deleting field 'Part.timestamp'
        db.delete_column('tomo_part', 'timestamp')

        # Deleting field 'ProblemSet.timestamp'
        db.delete_column('tomo_problemset', 'timestamp')
