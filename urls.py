...
urlpatterns = patterns('',
    ...
    (r'^course/', include(patterns('tomo.problem.views',
        url(r'^(?P<course_id>\d+)/$', 'view_course', name='course'),
    ))),
    (r'^problem_set/', include(patterns('tomo.problem.views',
        (r'^(?P<problem_set_id>\d+)/', include(patterns('tomo.problem.views.problem_set',
    ...
    (r'^problem/', include(patterns('tomo.problem.views.problem',
        (r'^(?P<problem_id>\d+)/', include(patterns('tomo.problem.views.problem',
