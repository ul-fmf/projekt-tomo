...
urlpatterns += patterns('tomo.problem.views',
    ...
    url(r'^collection/(?P<object_id>\d+)/download/$', 'download_collection',
        name='download_collection'),
    url(r'^problem/(?P<object_id>\d+)/solutions/$', 'solutions',
        name='solutions'),
    url(r'^collection/(?P<object_id>\d+)/solutions/(?P<user_id>\d+)/$', 'download_user_solutions',
        name='download_user_solutions'),
    url(r'^collection/(?P<object_id>\d+)/download_anonymous/$', 'download_anonymous_collection',
        name='download_anonymous_collection'),
