...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submissions_submission', (
            ...
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['problems.Problem'])),
        ...
        db.create_table(u'submissions_attempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attempts', to=orm['problems.Part'])),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attempts', to=orm['submissions.Submission'])),
        ...
        db.send_create_signal(u'submissions', ['Attempt'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'submissions_attempt')
